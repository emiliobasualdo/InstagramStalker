...
Class PHPTerminalProgressBar {
	...
	private $ouputFind = array(':current', ':total', ':elapsed', ':percent', ':eta', ':rate', ':optional');
	 ...
	 */
	public function tick($optional = "", $amount = 1) {
		$this->update($this->current + $amount, $optional);
	}

	public function update($amount, $optional = "") {
		$this->current = $amount;
